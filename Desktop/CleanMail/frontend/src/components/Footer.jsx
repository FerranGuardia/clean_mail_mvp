        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-blue-400">CleanMail</span>
              <span className="ml-2 text-sm text-gray-400">Professional Email Management</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Mantén tu Gmail profesional y nunca pierdas una factura importante.
              Organiza automáticamente tus emails con reglas inteligentes bilingües.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 CleanMail. Todos los derechos reservados.
            </p>
